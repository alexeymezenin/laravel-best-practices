...
------------ | ------------- | -------------
Авторизация | Политики | Entrust, Sentinel и др. пакеты
...
Аутентификация | Встроенный функционал | Сторонние пакеты
...
Обмен данными в рреальном времени | Laravel Echo, Pusher | Пакеты и работа с веб сокетами напрямую
...
Модель | User | ~~Users~~
Отношения hasOne и belongsTo в ед. ч. | article | ~~articles~~
Все остальные отношения во мн. ч. | articles | ~~article~~
...
Индексы в конфиге, языковых файлах | articles_enabled | ~~ArticlesEnabled; articles-enabled~~
