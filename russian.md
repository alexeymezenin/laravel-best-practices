...
[Свежие зависимости](#fresh-stable-dependencies)
...
Поддерживайте свою версию Laravel в актуальном состоянии со стабильным релизом фреймворка.

Стабильный релиз всегда содержит:
- исправления ошибок;
- исправления безопасности;
- новые возможности, полезные во время разработки;
