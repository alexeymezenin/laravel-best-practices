...
[<p dir="rtl">لا تضع ششفرات js و css داخل ملفات Blade ولا تضع أي ششفرات HTML في فئات php</p>](#10)
...
[<p dir="rtl">🔝 الرجوع للفهرس</p>](#الفهرس)
### <p dir="rtl">11</p>
### **<p dir="rtl">استخدم ملفات الإعدادت واللغاتK والثوابت بدلاً من النص داخل الشيفرة</p>**
...
<p dir="rtl">يفضل استخدام الأدوات المدمجة مع إطار عمل لارافيل والحزم المقترحة من مجتمع لارفيل عن استخدام غيرها، أي مطور سيعمل على تطبيقك في وقت لاحق سيحتاج تعلم تلك الأدوات التي لا يشيع استخدامها في تطبيقات لارافيل، وأيضاً أطلب المساعدة من مجتمع لارافيل عندما تقرر الإعتماد على أحد الأدوات أو الحزم، ولا تجع عميلك يدفع مقابل ذلك. </p>
...
راجع [PSR standards](http://www.php-fig.org/psr/psr-2/).
 ...
 <p dir="rtl">وأيض،, راجع اصطلاح التسميات المقبول من جهه مجتمع لارافيل:</p>
