...
[Bangla](bangla.md) (by [Anowar Hossain](https://github.com/AnowarCST))
...
[ফ্যাট মডেলস, স্কীনি কন্ট্রোলার](#fat-models-skinny-controllers)
...
[সমানে এসাইন করা](#mass-assignment)
...
[সরাসরি লেখা থেকে কনফিগারেশন, ল্যাঙ্গুয়েজ এবং কনস্টান্ট ফাইল ব্যাবহার করুন](#use-config-and-language-files-constants-instead-of-text-in-the-code)
...
[🔝 বিষয়বস্তুতে ফিরে যান](#contents)
