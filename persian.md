![بهترین راه حل های لاراول](/images/logo-persian.png?raw=true)


[laravel best practices](https://github.com/alexeymezenin/laravel-best-practices) (by [مرتضی زارعی زکلیکی](https://github.com/MortezaZareiZakliki))
...
این سند مربوط به اصول های برنامه نویسی مانند اصول SOLID یا الگوهای برنامه نویسی و ... نمی باشد بلکه پیدا کردن بهترین راه حل برای کدهایی که توسط برنامه نویسان در فریم ورک لاراول در پروژه های واقعی انجام می گیرد می باشد.

## محتوا

[مسئولیت تک واحدی](#single-responsibility-principle)
...
[Other خوب practices](#other-خوب-practices)

### **Single responsibility principle**

یک کلاس یا یک متد یا یک ت یاابع بهتر است که مسئولیت یک عمل یا یک کار را برعهده بگیرد و در حد امکان یک خروجی داشته باشد.
...
بجای آنکه اعتبار سنجی را داخل کنترلر انجام بدهیم 
...
بد (for 100 users, 101 DB queries will be executed):
...
خوب (for 100 users, 2 DB queries will be executed):
