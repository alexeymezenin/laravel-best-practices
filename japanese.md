...
[コメントを書く。ただしコメントよりも説明的なメソッド名と変数名のほうが良い](#コメントを書く。ただしコメントよりも説明的なメソッド名と変数名のほうが良い)
...
Eloquentにより読みやすくメンテナンスしやすいコードを書くことができます。また、Eloquentには論理削除、イベント、スコープなどの優れた組み込みツールがあります。
...
### **コメントを書く。ただしコメントよりも説明的なメソッド名と変数名のほうが良い**
...
------------ | ------------- | -------------
認証 | Policies | Entrust, Sentinel または他のパッケージ
...
認可 | 標準組み込み | サードパーティ製パッケージ、独自実装
API 認可 | Laravel Passport | サードパーティ製の JWT や OAuth パッケージ
